...
static func center_tri(corners):
	var x = (corners[0].x + corners[1].x + corners[2].x) / 3
	var y = (corners[0].y + corners[1].y + corners[2].y) / 3
	var z = (corners[0].z + corners[1].z + corners[2].z) / 3
